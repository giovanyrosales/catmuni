...
*/
    ...
    // Route::get('/admin/generar_notificacion/pdf/{f1}/{f2}/{t1}/{f3}/{id}', [reportesController::class, 'notificacion']); // Dompdf
    Route::get('/admin/generar_notificacion/pdf/{f1}/{f2}/{t1}/{f3}/{id}', [reportesController::class, 'notificacion2']); // Mpdf
    ...
    Route::get('/admin/reporte/resolucion_apertura/pdf/{id}', [reportesController::class, 'resolucion_apertura']);
        /* reportes pdf historial de cobros en empresas con mpdf*/
    ...
    Route::get('/admin/pdf//reporte/licor/cobros/{id_empresa}', [reportesController::class, 'pdfReporteLicorCobros']);
        /* Fin reportes pdf historial de cobros en empresa con mpdf */
    ...
    Route::get('/admin/reporte/reporte_cobros_diarios/index', [reportesController::class, 'indexReporteCobros_diarios'])->name('admin.sidebar.reporte.cobros_diarios');
    ...
    //REPORTES RÓTULOS
    Route::get('/admin/estado_cuenta/rotulos_detalle/pdf/{f1}/{f2}/{ti}/{f3}/{id_rotulos_detalle}', [reportesRotulosDetalleController::class, 'estado_cuentas_rotulos']);
    Route::get('/admin/generar_aviso/rotulos/pdf/{id_rotulos_detalle}', [reportesRotulosDetalleController::class, 'aviso_rotulos']);
