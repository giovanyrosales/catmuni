...
class reportesRotulosController extends Controller
{
 
    public function estado_cuenta_rotulos($f1, $f2, $ti, $ir, $id_empresa) 
    {   
        log::info([$f1, $f2, $ti, $ir, $id_empresa]);
        ...
        $view = View::make('backend.admin.Rotulos.Reportes.estado_cuenta_rotulos', compact([
