                        ...
                        <table border='0' align='center' style='width: 600px;'>
                            ...
                            <tr>
                                <td colspan='2' style='line-height: 17px;padding-top: -4px;'>
                                    <br>
                                    <p style='font-size: 12px;'><b>Señor (a):&nbsp;$rotulos->contribuyente&nbsp;$rotulos->apellido<br>
                                    Presente.</b></p>
                                    <p style='font-size: 12px;'><b>Cantidad de rotulos: &nbsp;$rotulos->cantidad_rotulos</b></p><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td align='justify' colspan='2' style='line-height: 17px;padding-top: -5px;'>
                                    ...
                                    <br>
                                    <br>
                                    Nombre del Negocio o Empresa en Mora:&nbsp; <strong>$rotulos->nom_empresa</strong><br>
                                    Direccion: &nbsp;<strong>$rotulos->dire_empresa</strong></p>
                                </td>
                            </tr>
                            <tr>
