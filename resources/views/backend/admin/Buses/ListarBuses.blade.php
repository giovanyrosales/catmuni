                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <thead>
                                    <tr>
                                        <th style="width: 15%; text-align: center">N° Ficha</th>
                                        <th style="width: 20%; text-align: center">Fecha Apertura</th>
                                        <th style="width: 35%; text-align: center">Representante</th>
                                        <th style="width: 22%; text-align: center">Cantidad de buses</th>   
                                        <th style="width: 18%; text-align: center">Total Tarifa</th>               
                                    ...
                                    <td>
                                        <input  id='nFicha-editar' disabled class='form-control' min='1' style='max-width: 250px' type='text' value=''/>
                                    </td> 
                                    ...
                                    <td> 
                                            ...
                                            <select class='form-control seleccion' disabled style='max-width: 300px' id='select_contribuyente-editar'>
...
<script>
    ...
    function InformacionBus(id)
    {
        ...
        axios.post(url+'/buses_detalle/informacion',{
            ...
            .then((response) => {
                ...
                if(response.data.success === 1){
                    ...
                    $('#nFicha-editar').val(response.data.buses_detalle.nFicha);
                    
                    console.log(cantidadBusEditar);
                    
                    document.getElementById("select_contribuyente-editar").options.length = 0;

                    $.each(response.data.contribuyente, function( key, val ){
                        if(response.data.id_contri == val.id){
                            $('#select_contribuyente-editar').append('<option value="' +val.id +'"data-pagoMEditar="'+val.tarifa+'" selected="selected">'+val.nombre+'&nbsp;'+val.apellido+'</option>');
                        }else{
                            $('#select_contribuyente-editar').append('<option value="' +val.id +'">'+val.nombre+'&nbsp;'+val.apellido+'</option>');
                        }
                    });
                    //****  /. Cargar información editar matrícula detalle  ****//
        ...
        function EditarBus()
        {
            ...
            var contribuyente_editar = document.getElementById('select_contribuyente-editar').value;
...
//* Inicia función multiplicar
        ...
        function agregarBus()
        {
            ...
            var empresa = document.getElementById("select_contribuyente").value; 
