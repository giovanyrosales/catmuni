...
<table border="0" align="center" style="width: 600px;">
        ...
        <tr>
            <td colspan="2">
                ...
                Empresa o Negocio:&nbsp;{{$empresa->nombre}}/Licencia Licor</p>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            ...
            <th scope="col">&nbsp;&nbsp;hasta&nbsp; {{$FechaPagara}}&nbsp;</th>    
        </tr>
        <tr>
            <td align="right">LICENCIAS</td>
            <td align="center">${{$monto_pago_licencia}}</td>
        </tr>
        <tr>
            <td align="right">MULTAS POR LICENCIA</td>
            <td align="center">${{$multaTotalLicor}}</td>
        </tr>
        <tr>
