                  ...
                  <div class="form-group">
                    ...
                    <table border="1" width:860px;>
                      ...
                      <tr>
                        ...
                        <td align="center"><h6 id="giro_empresarial_codigo"></td>
                        <td> </td>
...
function borrarCalificacion()
    {
     ...
     // se envia el ID del rótulo
      ...
      formData.append('id_empresa', id_empresa);
            ...
            axios.post(url+'/empresas/calificaciones/eliminar', formData, {
            })
              .then((response) => {
                closeLoading()
...
swalWithBootstrapButtons.fire({
  ...
  if (result.isConfirmed) {
    ...
    var formData = new FormData();
    formData.append('id_empresa', id_empresa);
    axios.post(url+'/empresas/calificacion/asignar_anterior', formData, {
      })
      .then((response) => {
          closeLoading();
          if(response.data.success === 1){
