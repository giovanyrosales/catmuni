    ...
    <div style="display: none; padding-bottom:30px;" id="divcontenedor">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5 class="modal-title"><i class="fas fa-history"></i>&nbsp;Histórico Solvencias.
                        </h5>
                    </div><!-- Col -->
                    <div class="col-sm-6">
        ...
        <div class="card" style=" margin: 5px auto;width: 98%;" id="contenido_historico_solvencias">
            <div class="progress" style="margin: 0 auto;width: 100%; height:5px;">
            ...
            <div class="card-body"  >
                ...
                <img src="{{ asset('/img/constancias_historial.png') }}" id="img_solvente" alt="reference-image" style="display: block; margin: 0px auto;width: 20%; height:20%;" >
                <!-- Inclución de tabla -->
                <div  id="div_historico_cs">
                    <div id="tablahistoricocs"></div>
                </div>
                <!-- Inclución de tabla -->
                <div id="div_historico_cg">
                    <div  id="tablahistoricocg"></div>
                </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        ...
        function cargar_historico_cs()
        {
            ...
            $('#img_solvente').hide();
            let ruta = "{{ url('/admin/contribuyentes/tabla/historicocs') }}";
        ...
        function cargar_historico_cg()
        {
            ...
            $('#img_solvente').hide();
            let ruta = "{{ url('/admin/contribuyentes/tabla/historicocg') }}";
